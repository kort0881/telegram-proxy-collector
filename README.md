...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-21 12:47 UTC*

**Отчёт о состоянии списка прокси (2026‑08‑21 12:34 UTC)**  

- В истории собрано **200** прокси‑серверов, все они находятся в категории «хорошие» (пинг < 1.5 с).  
- Прокси представлены только типом **mtproto**.  

**Рекомендации**  
- Для большинства задач оптимален выбор **eu**‑региональных прокси (160 шт.) — самый низкий средний пинг (0.09 с).  
- При необходимости доступа к российским ресурсам предпочтительнее **ru**‑прокси (38 шт., avg ping 0.13 с).  
- **us**‑прокси (2 шт.) тоже хороши, но их количество ограничено.  

**Аномалии**  
- Негативных отклонений не обнаружено: плохих прокси (>5 с) и резистентных к пробе нет.  
