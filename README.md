...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-02 19:44 UTC*

## Отчёт о состоянии прокси‑серверов (2026‑09‑02 12:34 UTC)

Список содержит **200** прокси, все они находятся в категории «хорошие» (пинг < 1.5 с). Прокси представлены единственным типом **mtproto** и распределены по регионам: **EU — 150**, **RU — 38**, **US — 12**.

**Рекомендация:**  
- Для максимальной скорости выбирайте **EU‑прокси** (средний пинг ≈ 
<!-- AI_ANALYTICS_END -->