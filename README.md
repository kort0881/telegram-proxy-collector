...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-12 08:54 UTC*

**Отчёт по прокси (2026‑09‑12 14:20 UTC)**  

- Всего прокси в истории: **200**; все имеют хорошее качество (ping < 1.5 с).  
- Региональное распределение: **EU – 156**, **US – 12**, **RU – 32**; тип всех прокси – **mtproto**.  
- Средний ping: **EU 0.06 с**, **US 0.07 с**, **RU 0.09 с**; процент probe‑res
<!-- AI_ANALYTICS_END -->