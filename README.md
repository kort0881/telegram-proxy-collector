...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-18 03:36 UTC*

## Отчёт о состоянии прокси‑списка (2026‑09‑18 12:00 UTC)

- **Всего прокси:** 200  
- **Качество:** 100 % хорошие (ping < 1.5 с), 0 % средних, 0 % плохих.  
- **Регионы:** EU — 198, US — 2.  
- **Типы:** MTProto — 40, SOCKS5 — 160.  
- **Источники:** данные отсутствуют.  

**Рекомендации:**  
- **Регион:** для большинства задач лучше использовать EU‑прокси — их почти все и они обладают низким пингом. US‑прокси
<!-- AI_ANALYTICS_END -->
