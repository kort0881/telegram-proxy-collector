...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-07 03:53 UTC*

### Отчёт о состоянии списков прокси-серверов
Текущее состояние списков прокси-серверов включает в себя 112 прокси, с преобладанием хороших прокси-серверов. Ниже представлена более подробная информация о распределении прокси-серверов по регионам и их качестве.

### Рекомендации
Рекомендуется использовать прокси-серверы из регионов `eu`, `us` и `ru`, поскольку они демонстрируют высокий процент хороших прокси-серверов (100%) и низкие средние значения пинга (около 0.06-0.08 секунд). Все прокси-серверы имеют тип `mtproto`.

### Аномалии
Присутствуют 12 прокси-серверов с неизвестным регионом и качеством, что может указывать на потенциальные проблемы с их работой. Однако общее количество плохих прокси-серверов (>5с) составляет всего 12, что не является критичным.
