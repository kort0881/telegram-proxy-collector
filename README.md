...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-25 08:43 UTC*

## Отчёт о состоянии прокси (2026‑08‑25 14:27 MSK)

- **Всего прокси в истории:** 200 — все находятся в категории «хороших» (ping < 1.5 с).  
- **Распределение по регионам:** EU — 160, RU — 36, Asia — 2, US — 2.  
- **Тип:** `mtproto` (100 % от общего числа).

**Рекомендация:**  
- Для большинства задач лучше использовать EU‑прокси – они самые быстрые (avg ping 0.09 с)
<!-- AI_ANALYTICS_END -->