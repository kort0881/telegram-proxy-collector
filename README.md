...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-06 17:14 UTC*

## Отчёт о состоянии прокси‑списков (2026‑09‑06 12:34 UTC)

- **Всего прокси:** 200  
- **Качество:** все 200 прокси находятся в категории «хорошие» (пинг < 1.5 с).  
- **Регионы:** EU — 142, US — 26, RU — 32.  
- **Тип:** MTProto — 200 (100 % от общего числа).  

### Рекомендация
Для максимально низкой задержки рекомендуется использовать **европейские (EU) и американские (US) MTProto‑прокси** – их средний пинг составляет 0.09‑0.10 с. Российские (RU) прокси тоже хороши (avg ping = 0.14 с), но чуть медленнее.

### Аномалии
Отчёт не выявил плохих или проблемных прокси – все узлы находятся в категории «хорошие», процент «probe‑resistant» = 0 % во всех регионах.
<!-- AI_ANALYTICS_END -->