...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-12 03:52 UTC*

## Отчёт о состоянии прокси (2026‑09‑12 14:35 UTC)

**Текущее состояние:** в истории собрано 200 прокси‑серверов, все они находятся в категории «хороших» (ping < 1.5 с).

- **Общее количество:** 200 (100 % хороших, 0 % средних и плохих).  
- **Регионы:** EU – 172, US – 8, RU – 20.  
- **Тип:** все – `mtproto`.  
