...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-20 09:07 UTC*

**Отчёт о состоянии прокси‑серверов (2026‑08‑20 12:34 UTC)**  

- **Общее количество прокси:** 200  
- **Качество:** 100 % — хорошие (ping < 1.5 с); плохих и средних прокси нет.  

### Рекомендации
- **Регион:** для минимального задержки предпочтительнее использовать прокси из **EU** (144 шт., средний ping ≈ 0.07 с).  
- **Тип:** все прокси — **mtproto**, что упрощает выбор: используйте любой из них, ориентируясь на нужный регион.  

### Аномалии
- Аномалий не обнаружено: плохих прокси нет, процент «probe‑resistant» = 0 % во всех регионах.  
<!-- AI_ANALYTICS_END -->