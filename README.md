...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-25 05:08 UTC*

**Отчёт о состоянии списка прокси (2026‑08‑25 14:32 UTC)**  

- В истории собрано **200** прокси‑серверов, все они находятся в категории «хороших» (пинг < 1.5 с).  
- Прокси распределены по регионам: **EU – 158**, **RU – 34**, **ASIA – 4**, **US – 4**.  
- Все прокси имеют тип **mtproto**.  

### Рекомендация  
Для большинства задач предпочтительно использовать **европейские (EU)** прокси – они дают минимальный средний пинг (0.08 с) и полностью покрыты хорошим качеством. При необходимости доступа из России можно выбрать **RU**‑прокси (пинг ≈ 0.15 с).  

### Аномалии  
Плохих прокси не обнаружено, проблемных отклонений в статистике нет.
<!-- AI_ANALYTICS_END -->