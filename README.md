...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-23 16:25 UTC*

## Отчёт о состоянии прокси (2026‑08‑23 12:00 UTC)

- **Всего прокси:** 200, из них **100 % «хорошие»** (ping < 1.5 с).  
- **Распределение по регионам:**  
  ...
  - Asia — 4  
- **Тип:** все **mtproto**.  
- **Средний ping:** от **0.04 с** (Asia) до **0.15 с** (US).  

### Рекомендация
- **EU** и **RU**‑прокси – оптимальны для большинства задач:
<!-- AI_ANALYTICS_END -->