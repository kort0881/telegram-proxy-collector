...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-03 19:10 UTC*

## Отчёт о состоянии списка прокси (2026‑09‑03 12:45 UTC)

- **Общее количество прокси:** 200  
- **Качество:** 100 % — хорошие (ping < 1.5 с), плохих и средних нет.  

### Рекомендации
- **Регион:** выбирайте прокси из нужного вам региона — EU (152 шт.), RU (40 шт.) или US (8 шт.).  
- **Тип:** все прокси — **mtproto**, что обеспечивает совместимость с Telegram.  

### Аномалии
- Аномалий не обнаружено: нет плохих или медленных прокси, процент «probe‑resistant» = 0 % во всех регионах.
<!-- AI_ANALYTICS_END -->