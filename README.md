...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-16 00:00 UTC*

**Отчёт о состоянии прокси‑серверов**  
*Дата и время: 2026‑09‑16 10:23 (UTC)*  

- В истории зафиксировано **200** прокси, все они находятся в категории «хороших» (пинг < 1.5 с).  
- **Регионы:** EU — 192, US — 4, RU — 4.  
- **Типы:** MTProto — 114, SOCKS5 — 86.  

**Рекомендации**  
- Для большинства задач предпочтительно использовать **EU‑прокси**, так как они составляют 96 % от общего пула и обладают отличным откликом.  
- Если требуется совместимость с Telegram‑клиентами, выбирайте **MTProto**; для более универсального доступа (HTTP/HTTPS, SOCKS) — **SOCKS5**.  
