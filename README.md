...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-27 09:45 UTC*

### Отчёт о состоянии списков прокси-серверов
Текущее состояние списков прокси-серверов включает в себя 112 прокси из различных регионов и типов. Ниже приведена рекомендация по выбору прокси-серверов на основе имеющихся данных.

### Рекомендация
Рекомендуется использовать прокси-серверы из региона `eu`, поскольку они демонстрируют лучшее качество (43,3% хороших прокси) и приемлемый средний пинг (2,51 секунды). По типу прокси предпочтительны `mtproto`, так как их количество значительно больше, чем `socks5`, и они могут обеспечить более стабильную связь.

### Аномалии
Обнаружено значительное количество прокси-серверов с неизвестным регионом и низким качеством, что может указывать на потенциальные проблемы с их использованием. Кроме того, регион `ru` демонстрирует отсутствие хороших прокси, что может быть связано с различными ограничениями или проблемами.
