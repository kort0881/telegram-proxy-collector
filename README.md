...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-19 17:02 UTC*

## Отчёт о состоянии прокси (2026‑09‑19 10:00 UTC)

- **Всего прокси:** 200  
- **Качество:** 200 хороших (ping < 1.5 с), 0 средних, 0 плохих  
- **Региональное распределение:** EU – 194, US – 6  
- **Типы:** MTProto – 58, SOCKS5 – 142  

**Рекомендация:**  
Для большинства задач лучше использовать быстрые SOCKS
<!-- AI_ANALYTICS_END -->
