...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-22 00:38 UTC*

**Отчёт о состоянии прокси‑списков (2026‑09‑22 14:35 UTC)**  

- **Общее количество прокси:** 200  
- **Качество:** все прокси находятся в категории *хороших* (пинг < 1.5 с).  
- **Регионы:** 100 % — EU.  
- **Типы:** mtproto — 6, socks5 — 194.  
- **Источники:** данные отсутствуют.

**Рекомендация:**  
Для большинства задач оптимально использовать **socks5**‑прокси из региона **EU**, так как они составляют подавляющее большинство и обладают хорошим пингом. При необходимости более надёжного соединения (например, для Telegram) можно задействовать небольшую часть **mtproto**‑прокси.
