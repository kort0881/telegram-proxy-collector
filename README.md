...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-27 19:18 UTC*

### Отчёт о прокси-серверах
Текущее состояние списков прокси-серверов включает в себя 88 записей с различным качеством и регионами. Анализ показывает, что большинство прокси-серверов расположены в регионе "eu" и представлены типами "mtproto" и "socks5".

### Рекомендации
Рекомендуется использовать прокси-серверы из региона "eu", так как они демонстрируют более высокий процент хороших соединений (51,32%) и относительно низкий средний пинг (2,32с). Предпочтение следует отдавать типам "mtproto" и "socks5" из-за их высокой распространённости и стабильности.

### Аномалии
Обнаружено, что 12 прокси-серверов имеют неизвестный регион и демонстрируют плохие показатели качества, включая 0% хороших соединений и очень высокий средний пинг. Также 12 плохих прокси-серверов (>5с) могут вызывать проблемы при использовании.

### Дата отчёта
Отчёт сформирован: 27 июня 2026 года
<!-- AI_ANALYTICS_END -->