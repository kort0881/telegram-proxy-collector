...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-13 03:57 UTC*

**Отчёт о состоянии списка прокси (13 sep 2026 12:00 UTC)**  

В истории собрано **200** прокси‑серверов, все они относятся к категории «хороших» (пинг < 1.5 с).  

**Рекомендации**  
- **Регион:** используйте прокси из **EU** (152 шт.) — наименьший средний пинг (0.05 с). При необходимости доступа из США или России подходят соответственно **US** (20 шт., avg 0.07 с) и **RU** (28 шт., avg 0.09 с).  
- **Тип:** все прокси — **mtproto**, поэтому выбор по типу ограничен.  

**Аномалии**  
Отсутствуют: плохих прокси (пинг > 5 с) нет, процент «probe‑resistant» = 0 % во всех регионах.
<!-- AI_ANALYTICS_END -->