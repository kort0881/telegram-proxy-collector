...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-21 09:40 UTC*

**Отчёт о состоянии списка прокси (2026‑09‑21 12:34 UTC)**  

- **Общее количество прокси:** 200 — все находятся в категории «хороших» (пинг < 1.5 с).  
- **Распределение по регионам:** EU — 186, US — 6, RU — 8.  
- **Типы прокси:** MTProto — 60, SOCKS5 — 140.  

**Рекомендации:**  
- Для большинства задач предпочтительно использовать **EU‑прокси**, так как они составляют более 90 % списка и обеспечивают минимальный пинг.  
- Если нужен доступ к Telegram‑API, выбирайте **MTProto**; для общих HTTP/HTTPS‑запросов лучше подходят **SOCKS5**.  

**Аномалии:**  
- Плохих прокси не обнаружено, список полностью состоит из качественных узлов.
<!-- AI_ANALYTICS_END -->
