...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-03 03:41 UTC*

**Отчёт (2026‑09‑03 10:15 UTC)**  

- Всего прокси в истории: **200**, все они **хорошего качества** (ping < 1.5 с).  
- Тип: **mtproto** — 100 % всех записей.  
- Распределение по регионам: **EU – 162**, **US – 12**, **RU – 26**; средний ping ≈ 0.06‑0.09 с, **probe‑resistant** = 0 %.

**Рекомендации**  
- Для большинства задач выбирайте **EU‑прокси** – они обладают самым низким средним ping
<!-- AI_ANALYTICS_END -->