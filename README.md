...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-26 01:17 UTC*

## 📊 Отчёт о прокси‑серверах (2026‑08‑26 10:45 UTC)

**Вводные данные**  
В истории собрано **200** прокси‑серверов, все они находятся в категории *«хороших»* (пинг < 1.5 с).  

**Рекомендация**  
- **Регион:** предпочтительно использовать прокси из **EU** (152 шт.) — они составляют ≈ 76 % от общего количества и имеют самый низкий средний пинг (0.07 с).  
- **Тип:** все прокси имеют тип **mtproto**, что упрощает выбор — используйте любой из них.  

**Аномалии**  
Плохих или средних прокси не обнаружено, а также нет резистентных к probe‑проверкам серверов.  
