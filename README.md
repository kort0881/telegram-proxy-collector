...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-06 04:03 UTC*

## Отчёт о состоянии списков прокси-серверов
Текущий список прокси-серверов содержит 112 записей, большинство из которых имеют хорошее качество и расположены в регионе Европы. Ниже представлена краткая рекомендация по выбору прокси-серверов.

### Рекомендация
Для оптимальной работы рекомендуется использовать прокси-серверы из регионов Европы (`eu`), США (`us`) и России (`ru`), поскольку они демонстрируют 100% уровень хороших прокси с низкой задержкой (в среднем 0,08-0,14 секунды). Все прокси-серверы имеют тип `mtproto`.

### Аномалии
В списке присутствуют 12 прокси-серверов неизвестного региона (`unknown`), которые не демонстрируют хороших показателей. Их использование не рекомендуется.
