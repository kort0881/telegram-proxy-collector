...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-21 16:15 UTC*

## Отчёт о состоянии прокси (2026‑09‑21 14:30 UTC)

**Введение:**  
В истории собрано 150 прокси‑серверов, все они находятся в категории «хорошее» качество (пинг < 1,5 с).

**Рекомендации:**  
- **Регион:** предпочтительно использовать прокси из Европы — 142 из 150 (наименьшая задержка).  
- **Тип:** оба типа работают стабильно; если нужен более широкий пул, выбирайте **socks5** (100 шт.), для специфических задач — **mtproto** (50 шт.).

**Аномалии:**  
Плохих или средних прокси не обнаружено, аномалий нет.
<!-- AI_ANALYTICS_END -->
