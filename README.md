...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-12 23:48 UTC*

**Отчёт о состоянии списка прокси (12 сен 2026 г., 12:00 UTC)**  

- В истории собрано **200** прокси‑серверов, все они **mtproto**‑типа.  
- Качество отличное: **100 %** прокси имеют пинг < 1.5 с (good = 200, medium = 0, bad = 0).  
- Распределение по регионам: **EU – 162**, **US – 12**, **RU – 26**. Средний пинг: EU 0.09 с, US 0.06 с, RU 0.13 с. Прокси, устойчивые к пробе, отсутствуют.

### Рекомендация
Для большинства задач лучше использовать **EU‑прокси** (наибольшее количество и стабильно низкий пинг). При необходимости доступа к ресурсам, оптимизированным под США, подойдёт небольшая партия **US‑прокси**. **RU‑прокси** также хороши, но их чуть меньше и пинг слегка выше.
