...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-20 03:41 UTC*

## Отчёт о состоянии прокси‑серверов (2026‑09‑20 12:00 UTC)

- **Всего прокси в истории:** **200**; все находятся в категории «хорошее» качество (ping < 1.5 с).  
- **Регионы:** **EU – 190**, **US – 8**, **RU – 2**.  
- **Типы:** **MTProto – 48**, **Socks5 – 152**.  

### Рекомендации
- **Регион:** для большинства задач оптимальны EU‑прокси (95 % пула) — низкий пинг и широкая доступность.  
- **Тип:**  
  - **MTProto**
<!-- AI_ANALYTICS_END -->
