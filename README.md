...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-10 09:11 UTC*

```markdown
## Отчёт о состоянии списка прокси (2026‑09‑10 12:34 UTC)

**Текущее состояние:** В истории зафиксировано 200 прокси‑серверов, все они находятся в категории «хорошие» (пинг < 1.5 с).  

**Рекомендации:**  
- **Тип:** используйте `mtproto` – единственный доступный и полностью рабочий тип.  
- **Регион:** предпочтительно выбирать европейские (`eu`) прокси (164 шт., средний пинг ≈ 0.08 с) и американские (`us`) (10 шт., средний пинг ≈ 0.06 с) для лучшей скорости; российские (`ru`) тоже хороши (26 шт., средний пинг ≈ 0.11 с).  

**Аномалии:** Проблемных прокси не обнаружено – плохих и средних прокси нет, процент «probe‑resistant» = 0 % во всех регионах.
```
<!-- AI_ANALYTICS_END -->