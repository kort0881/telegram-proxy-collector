...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-13 22:40 UTC*

**Отчёт по прокси‑серверам (2026‑09‑13 09:42:00 UTC)**  

- Всего в истории — 200 прокси, все — mtproto.  
- Качество: хорошие (ping < 1.5 с) — 200 (100 %); средних и плохих нет.  

**Распределение по регионам**  
| Регион | Кол‑во | Средний ping, с | % хороших | % probe‑resistant |
|--------|--------|----------------|-----------|-------------------|
| EU | 160 | 0.08 | 100 % | 0 % |
| US | 12  | 0.06 | 100 % | 0 % |
| RU | 28  | 0.13 | 100 % | 0 % |
...
**Рекомендации**  
- Для большинства задач оптимален выбор **EU‑прокси** (наибольшее количество и минимальный ping).  
- При необходимости доступа
<!-- AI_ANALYTICS_END -->