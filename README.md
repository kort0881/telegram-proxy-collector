...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-19 20:08 UTC*

## Отчёт о состоянии прокси (2026‑09‑19 12:34 UTC)

- **Всего прокси:** 200, из них **200** — хорошие (ping < 1.5 с), средних и плохих нет.  
- **Регионы:** EU — 194, RU — 6.  
- **Типы:** mtproto — 50, socks5 — 150.  

**Рекомендация:**  
- Для большинства задач лучше использовать европейские прокси (EU), так как они составляют 97 % списка и показывают отличный ping.  
- Если нужен протокол, оптимизированный для Telegram, выбирайте `mtproto`.  
- Для общего HTTP/HTTPS
<!-- AI_ANALYTICS_END -->
