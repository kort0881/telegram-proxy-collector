...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-22 13:09 UTC*

**Отчёт о состоянии списка прокси (2026‑09‑22 14:35 UTC)**  

- В истории зафиксировано **200** прокси, все из них имеют **хорошее качество** (пинг < 1.5 с).  
- Преобладающие регионы: **EU** — 196 прокси, **RU** — 4 прокси.  
- Типы: **Socks5** — 170, **MTProto** — 30.  

**Рекомендация:**  
- Для большинства задач предпочтительно использовать **Socks5**‑прокси из **EU**, так как они самые многочисленные и обладают хорошим пингом.  
- При необходимости доступа к сервисам, требующим MTProto, можно задействовать 30 доступных MTProto‑прокси (в том числе RU‑регион).  

**Аномалии:**  
- Отсутствуют; плохих прокси не обнаружено.
<!-- AI_ANALYTICS_END -->
