...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-27 13:25 UTC*

## Отчёт о прокси-серверах
Текущий список прокси-серверов насчитывает 99 записей, с различным качеством и географическим расположением. Ниже приведена сводка данных и рекомендации по выбору прокси.

### Качество и регионы
- Всего прокси: 99
- Качество: хороших — 52, средних — 35, плохих — 12
- Регионы: неизвестно — 12, Европа (eu) — 85, Россия (ru) — 2
- Типы: mtproto — 47, socks5 — 52

### Статистика по регионам
| Регион | Всего | Хороших (%) | Средний пинг (с) | Устойчивость к проверке (%) |
| --- | --- | --- | --- | --- |
| неизвестно | 12 | 0.0 | 999.0 | 0.0 |
| eu | 85 | 61.18 | 1.89 | 0.0 |
| ru | 2 | 0.0 | 4.65 | 0.0 |

### Рекомендации
Рекомендуется использовать прокси-сервера из Европы (eu) типа socks5, так как они демонстрируют наибольшее количество хороших прокси (61.18% с средним пингом 1.89с).

### Предупреждения
Обнаружено 12 прокси-серверов с неизвестным регионом и качеством, что может указывать на потенциальные проблемы с их работой. Также 12 прокси-серверов имеют плохое качество (>5с), что может негативно повлиять на производительность.

### Дата отчёта
Отчёт сформирован: 27 июня 2026 г.
<!-- AI_ANALYTICS_END -->