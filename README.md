...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-25 10:34 UTC*

**Отчёт о состоянии прокси‑серверов (2026‑08‑25 12:00 UTC)**  

- **Общее количество прокси:** 200 — все находятся в истории.  
- **Качество:** 100 % (пинг < 1.5 с); плохих и средних прокси нет.  

### Рекомендации
- **Тип:** используйте только `mtproto` – единственный доступный и полностью «хороший».  
- **Регион:**  
  - **EU (154 прокси, avg ping ≈ 0.09 с)** – оптимальный выбор для большинства задач.  
  - **RU (40 прокси, avg ping ≈ 0.15 с)** – хороший вариант для доступа к ресурсам в России.  
  - **US (4 прокси, avg ping ≈ 0.15 с)** и **ASIA (2 прокси, avg ping ≈ 0.04 с)** – пригодны при необходимости гео‑таргетинга, но их количество ограничено.  

### Аномалии
- Никаких аномалий не обнаружено: плохих прокси нет, процент «probe‑resistant» = 0 % во всех регионах.  
