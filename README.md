...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-19 23:56 UTC*

## Отчёт о состоянии прокси (2026‑09‑19 12:34 UTC)

- **Всего прокси:** 200  
- **Качество:** 198 хороших (ping < 1.5 с), 2 средних (1.5–5 с), 0 плохих  
- **Регионы:** EU – 198, US – 2  
- **Типы:** MTProto – 72, SOCKS5 – 128  

**Рекомендация:**  
- Для большинства задач лучше использовать европейские (`eu`) SOCKS5‑прокси – они составляют большинство качественных соединений.  
- MTProto‑прокси подходят для работы с Telegram.  
- При необходимости доступа к ресурсам в США применяйте доступные US‑прокси.

**Аномалии:** Плохих прокси не обнаружено
<!-- AI_ANALYTICS_END -->
