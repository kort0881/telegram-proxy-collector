...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-26 20:16 UTC*

## Отчёт о состоянии прокси‑серверов (2026‑08‑26 14:27 UTC)

- **Всего прокси в истории:** 200  
- **Качество:** все 200 прокси — *хорошие* (пинг < 1.5 с)  
- **Тип:** mtproto (100 %)  
- **Распределение по регионам:**  
  - EU — 148 (avg ping 0.08 с)  
  - RU — 42 (avg ping 0.12 с)  
  - US
<!-- AI_ANALYTICS_END -->