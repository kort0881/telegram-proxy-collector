...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-21 10:31 UTC*

## Отчёт о состоянии прокси (2026‑08‑21 14:35 UTC)

Список прокси полностью актуален: **200** записей, все имеют хороший пинг (< 1.5 с).

- **Рекомендация:**  
  - **Тип:** используйте `mtproto` — единственный доступный тип и все они находятся в хорошем состоянии.  
  - **Регион:** предпочтительно EU (`170` штук, средний пинг ≈ 0.07 с) или RU (`28` штук, средний пинг ≈ 0.11 с). США представлены лишь двумя прокси (пинг ≈ 0.13 с).  

- **Аномалии:** плохих или медленных прокси не обнаружено.  

*Данные взяты из текущей истории прокси‑серверов.*
<!-- AI_ANALYTICS_END -->