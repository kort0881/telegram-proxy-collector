...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-16 10:56 UTC*

## Отчёт о состоянии прокси‑списков (2026-09-16 10:45 UTC)

- **Всего прокси:** 200  
- **Качество:** 100 % хороших (ping < 1.5 с), 0 % средних, 0 % плохих.  
- **Распределение по регионам:** EU – 168, US – 4, RU – 28.  
- **Типы:** MTProto – 90, SOCKS5 – 110.  

**Рекомендации:**  
- Для большинства задач предпочтительно использовать EU‑прокси из‑за
<!-- AI_ANALYTICS_END -->
