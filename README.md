...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-05 22:03 UTC*

**Отчёт о состоянии списка прокси (2026‑09‑05 14:32 UTC)**  

- **Вводное:** В истории собрано 200 прокси‑серверов, все они находятся в категории «хороших» (пинг < 1.5 с).  
- **Рекомендация:** Для большинства задач предпочтительнее использовать EU‑прокси (152 шт.) — они самые многочисленные и имеют минимальный средний пинг (0.06 с). При необходимости доступа из России выбирайте RU‑прокси (40 шт., avg ping = 0.09 с). US‑прокси (8 шт.) также доступны, но их количество ограничено. Все прокси имеют тип **mtproto**.  
- **Аномалии:** Проблемных прокси не обнаружено (0 % плохих, 0 % probe‑resistant).
<!-- AI_ANALYTICS_END -->