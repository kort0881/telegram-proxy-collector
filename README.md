...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-10 03:49 UTC*

### Отчёт о прокси-серверах
Текущий список прокси-серверов содержит 112 записей, большинство из которых расположены в регионе Европы. Состояние списка прокси-серверов характеризуется высоким процентом хороших прокси.

### Рекомендация
Рекомендуется использовать прокси-серверы из регионов Европы (`eu`), России (`ru`) и США (`us`), так как они демонстрируют высокое качество и низкие средние значения пинга. Тип `mtproto` является единственным доступным типом прокси.

### Аномалии
Присутствуют 12 прокси-серверов неизвестного региона с плохим качеством, что может указывать на необходимость их проверки и потенциального удаления из списка.
