...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-02 17:50 UTC*

### Отчёт о прокси-серверах
Текущий список прокси-серверов насчитывает 112 записей, среди которых преобладают прокси из региона Европы (eu) с высоким качеством. Ниже приведена краткая аналитика и рекомендации по выбору подходящих прокси.

### Рекомендация
Рекомендуется использовать прокси-серверы из регионов «eu» и «ru», так как они демонстрируют 100% уровень хороших прокси с низким пингом (в среднем 0.07с и 0.09с соответственно). Все прокси-серверы поддерживают тип «mtproto».

### Аномалии
Обнаружено наличие 12 прокси-серверов с неизвестным регионом и качеством, из которых все отнесены к категории плохих прокси (>5с). Использование этих прокси-серверов не рекомендуется.
