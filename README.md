...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-15 10:00 UTC*

## Отчёт о состоянии прокси (2026‑09‑15 10:00 UTC)

- **Всего прокси:** 200  
- **Качество:** хорошие (ping < 1.5 с) — 200, средние — 0, плохие — 0  
- **Регионы:** EU — 166, US — 12, RU — 22  
- **Тип:** mtproto — 200  

**Рекомендация:**  
- Для большинства задач лучше использовать европейские (`eu`) прокси — они преобладают в списке и обладают отличным пингом.  
- При необходимости доступа к ресурсам США выбирайте `us`‑прокси, а для работы с российскими сервисами — `ru`‑прокси.  
- Все доступные прокси имеют тип `mtproto
<!-- AI_ANALYTICS_END -->