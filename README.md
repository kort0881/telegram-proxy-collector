...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-08 22:54 UTC*

**Отчёт о состоянии списка прокси (2026‑09‑08 12:34 UTC)**  

- В истории собрано **200** прокси‑серверов, все они имеют **хорошее качество** (пинг < 1.5 с).  
- Прокси представлены только типом **mtproto**.  
- Распределение по регионам: **EU – 162**, **US – 18**, **RU – 20**; средний пинг ≈ 0.09 с (EU/US) и 0.15 с (RU).  

**Рекомендация:**  
Для большинства задач предпочтительно использовать **mtproto‑прокси из EU** – наибольшее количество и минимальный пинг. При необходимости доступа из США или России выбирайте соответствующие региональные прокси (US, RU) – их качество также 100 % хороших.

**Аномалии:**  
Плохих прокси не обнаружено, список полностью здоров.
<!-- AI_ANALYTICS_END -->