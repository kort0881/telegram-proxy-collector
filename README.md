...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-20 23:53 UTC*

## Отчёт о состоянии прокси (2026‑09‑20 12:34 UTC)

- **Всего прокси в истории:** 200  
- **Качество:** все 200 прокси находятся в категории «хорошие» (пинг < 1.5 с).  
- **Регионы:** US – 4, EU – 196.  
- **Типы:** MTProto – 22, SOCKS5 – 178.  
- **Источники:** данные отсутствуют.

### Рекомендация
Для большинства задач предпочтительно использовать **EU‑прокси** (доминируют в наборе) и **SOCKS5** (большинство, более универсальны). MTProto может пригодиться только при работе с Telegram API.

### Аномалии
Отсутствуют: плохих прокси и средних по пингу нет.
