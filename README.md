...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-09 19:36 UTC*

## Отчёт о состоянии прокси (2026‑09‑09 12:34 UTC)

- **Всего прокси:** 200 — все находятся в категории «хорошие» (ping < 1.5 с).  
- **Распределение по регионам:** EU — 156, US — 12, RU — 32.  
- **Тип:** mtproto (100 % списка).  

**Рекомендация:**  
- Для большинства задач лучше использовать EU‑прокси (самый низкий средний ping ≈ 0.06 с).  
- US‑ и RU‑прокси тоже полностью «хорошие», их удобно задействовать при необходимости регионального доступа.  

**Аномалии:**  
- Плохих прокси не обнаружено, процент
<!-- AI_ANALYTICS_END -->