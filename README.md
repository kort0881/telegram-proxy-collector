...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-14 17:47 UTC*

### Отчёт о прокси-серверах
Текущее состояние списков прокси-серверов выглядит стабильным, с полным отсутствием прокси-серверов со средним и плохим качеством. Всего в истории зафиксировано 200 прокси-серверов, все из которых имеют хорошее качество (пинг < 1,5 секунды).

Рекомендуется использовать прокси-серверы из региона `eu`, поскольку их количество самое большое (156 серверов) и все они имеют хорошее качество. Также можно рассматривать прокси-сервера из регионов `us`, `asia` и `ru`, но их количество значительно меньше. Что касается типа прокси, все серверы являются `mtproto`, что делает их пригодными для использования в соответствующих приложениях.

Поскольку все прокси-серверы имеют хорошее качество, не существует аномалий, связанных с большим количеством плохих прокси.

Отчёт сформирован: 14 июля 2026 г.
<!-- AI_ANALYTICS_END -->