...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-01 08:44 UTC*

### Отчёт о состоянии прокси-серверов
Текущий список прокси-серверов насчитывает 112 записей, из которых подавляющая часть имеет хорошее качество и находится в регионе Европы. Большинство прокси-серверов поддерживают только тип mtproto.

### Рекомендации
Рекомендуется использовать прокси-серверы из региона Европы (eu) или России (ru), так как они демонстрируют 100% уровень хорошего качества и низкие показатели пинга. Все прокси-серверы типа mtproto могут быть использованы, поскольку они составляют весь список.

### Аномалии
Присутствует небольшое количество прокси-серверов неизвестного региона ('unknown') с плохим качеством, но их доли очень мала и не должна существенно повлиять на общую производительность.
