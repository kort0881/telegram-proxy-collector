...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-08 21:10 UTC*

### Отчёт о состоянии прокси-серверов
Текущее состояние списков прокси-серверов включает в себя 112 прокси, с доминированием хороших прокси с пингом менее 1,5 секунды. Большинство прокси расположены в регионе Европы.

### Рекомендация
Рекомендуется использовать прокси из регионов Европы (`eu`), России (`ru`) и США (`us`), так как они демонстрируют высокий процент хороших прокси с низким пингом. Все прокси-серверы имеют тип `mtproto`.

### Аномалии
Обратите внимание, что существует 12 прокси-серверов с неизвестным регионом и высоким пингом, что может указывать на потенциальные проблемы с их работой. При выборе прокси-серверов следует отдавать предпочтение тем, у которых известен регион и низкий пинг.
