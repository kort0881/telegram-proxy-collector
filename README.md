...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-22 06:40 UTC*

**Отчёт о состоянии прокси‑списков (2026‑08‑22 14:35 UTC)**  

В истории собрано **200** MTProto‑прокси, все они находятся в категории «хорошие» (пинг < 1.5 с).  

**Рекомендации:**  
- **EU (160 прокси)** – наилучший выбор для большинства задач: средний пинг ≈ 0.07 с, 100 % хороших.  
- **RU (36 прокси)** – хороший вариант для работы с российскими сервисами (пинг ≈ 0.13 с).  
- **Asia (4 прокси)** – пригодны, если нужен минимальный пинг в азиатском регионе (пинг ≈ 0.01 с).  

**Аномалии:** плохих прокси не обнаружено, все источники показывают 100 % хороших и 0 % «probe‑resistant».  

*Отчёт подготовлен автоматически и может быть обновлён при появлении новых данных.*
<!-- AI_ANALYTICS_END -->