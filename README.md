...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-09 14:42 UTC*

## Отчёт о состоянии списка прокси (2026‑09‑09 12:00 UTC)

- **Общее количество прокси:** 200  
- **Качество:** все 200 прокси находятся в категории «хорошие» (ping < 1.5 с). Средних и плохих прокси нет.  

### Рекомендации
- **Тип:** используйте **mtproto** – единственный доступный тип и он полностью качественный.  
- **Регион:**  
  - **EU** – наибольшее количество (156) с самым низким средним ping = 0.08 с.  
  - **US** – 10 прокси, avg ping = 0.05 с (самый быстрый).  
  - **RU** – 34 прокси, avg ping = 0.11 с.  

Для большинства задач предпочтительно выбирать **EU**‑прокси (наибольшее покрытие) либо **US**‑прокси, если требуется минимальный ping.  
