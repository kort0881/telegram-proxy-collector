...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-23 07:25 UTC*

## Отчёт о состоянии прокси (2026‑09‑23 14:05 UTC)

- **Всего прокси:** 72  
- **Качество:** 100 % хороших (ping < 1.5 с)  
- **Регионы:** eu – 62, us – 4, ru – 6  
- **Типы:** mtproto – 20, socks5 – 52  

**Рекомендация:**  
Для большинства задач лучше использовать `socks5`‑прокси из
<!-- AI_ANALYTICS_END -->
