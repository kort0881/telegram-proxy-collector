...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-29 23:27 UTC*

### Отчёт о состоянии прокси-серверов
Текущее состояние списков прокси-серверов включает в себя 112 записей, с преобладанием прокси из региона EU. Большинство прокси-серверов имеют хорошее качество, с пингом менее 1,5 секунды.

### Рекомендации
Рекомендуется использовать прокси-серверы из региона EU, так как они имеют наивысший процент хороших прокси (100%) и низкий средний пинг (0,1 секунды). Все прокси-серверы имеют тип mtproto.

### Аномалии
Нет значительных аномалий, но стоит отметить, что 12 прокси-серверов имеют неизвестный регион и плохое качество (пинг > 5 секунд).
