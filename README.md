...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-19 08:35 UTC*

## Отчёт о прокси (2026‑09‑19 12:34 UTC)

- **Всего прокси:** 200 (хороших – 198, средних – 2, плохих – 0)  
- **Региональное распределение:** EU 172, US 6, RU 22  
- **Типы:** SOCKS5 132, MTProto 68  

**Рекомендация:**  
Для большинства задач предпочтительнее использовать быстрые SOCKS5‑прокси из Европы (EU) — они составляют более 85 % списка и почти все имеют пинг < 1.5 с. MTProto‑прокси пригодятся, если нужен специфический доступ к Telegram.
