...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-27 06:59 UTC*

### Отчёт о прокси-серверах
Текущий список прокси-серверов насчитывает 112 записей, распределённых по разным регионам и типам. Ниже приведена краткая характеристика списка и рекомендации по выбору прокси.

### Рекомендации
Рекомендуется использовать прокси-серверы из региона `'eu'`, поскольку они демонстрируют лучшие показатели качества (50% хороших прокси) и средний пинг в 2.27 секунды. Также можно рассмотреть использование прокси типа `'mtproto'`, которые составляют большинство (63) в списке.

### Аномалии
В списке наблюдается большое количество прокси-серверов с неизвестным регионом (`'unknown'`), которые не демонстрируют хороших показателей качества. Обратите внимание на эти прокси при выборе.
