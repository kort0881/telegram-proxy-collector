...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-04 12:35 UTC*

### Отчёт о состоянии прокси-серверов
Текущий список прокси-серверов насчитывает 112 записей, с преобладанием хороших прокси-серверов. Для выбора прокси-серверов рекомендуется отдавать предпочтение регионам "eu", "us" и "ru", где наблюдается высокий процент хороших прокси-серверов с низкой задержкой.

### Рекомендации
По регионам:
- eu: 85 прокси-серверов с средней задержкой 0.06 секунд
- us: 6 прокси-серверов с средней задержкой 0.08 секунд
- ru: 9 прокси-серверов с средней задержкой 0.09 секунд
По типу:
- mtproto: 112 прокси-серверов

### Предупреждение
Наблюдается небольшое количество прокси-серверов с неизвестным регионом и высокими показателями задержки, но в целом список выглядит удовлетворительным.
