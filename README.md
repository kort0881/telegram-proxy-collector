...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-19 03:23 UTC*

**Отчёт о состоянии прокси‑списков**  
*Дата и время: 2026‑09‑19 12:34 UTC*  

- В истории зафиксировано **200** прокси‑серверов.  
- **Качество:** все 200 прокси находятся в категории «хорошие» (пинг < 1.5 с). Средних и плохих прокси нет.  
- **Регионы:** `eu` — 196, `ru` — 4.  
- **Типы:** `mtproto` — 54, `socks5` — 146.  

**Рекомендации**  
- Для большинства задач предпочтительно использовать **EU‑прокси** (96 % от общего количества) из‑за их высокой скорости и стабильности.  
- Если требуется совместимость с Telegram‑API, выбирайте **mtproto**; иначе лучше использовать **socks5** — их больше и они также показывают хороший пинг.  

**Аномалии**  
- Аномалий не обнаружено: плохих прокси нет, все находятся в хорошем диапазоне.
<!-- AI_ANALYTICS_END -->
