...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-09-17 17:58 UTC*

**Отчёт о текущем состоянии прокси‑списков (2026‑09‑17 12:34 UTC)**  

- Всего прокси в истории: **200**  
- Качество: хорошие (< 1.5 с) — **200**, средние (1.5–5 с) — **0**, плохие (> 5 с) — **0**  
- Распределение по регионам: **EU — 186**, **US — 6**, **RU — 8**  
- Типы: **MTProto — 62**, **SOCKS5 — 138**  

**Рекомендации**  
- Для большинства задач предпочтительно использовать **EU‑прокси**, так как они составляют почти 93 % списка и обладают хорошим пингом.  
- Если требуется более высокая анонимность или работа с Telegram, выбирайте **MTProto**; для универсального доступа — **SOCKS5**.  
