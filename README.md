...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-21 20:54 UTC*

**Отчёт о состоянии прокси (2026‑08‑21 10:00 UTC)**  

Список прокси полностью актуален: из 200 записей все имеют хороший пинг < 1,5 с.

**Рекомендации**  
- **Тип:** используйте только `mtproto` – это единственный доступный тип и он полностью отвечает требованиям.  
- **Регион:** для минимального задержки выбирайте прокси из **EU** (130 шт., средний пинг 0,08 с). При необходимости доступа к русскоязычным ресурсам подойдут **RU** (42 шт., пинг 0,14 с). Для тестов из Азии и США используйте соответствующие группы (4 шт. и 24 шт. со средним пингом 0,05‑0,14 с).

**Аномалии**  
Плохих прокси не обнаружено, процент «probe‑resistant» = 0 % во всех регионах.  
